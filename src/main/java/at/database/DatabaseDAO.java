...
/**
 * Абстрактный класс, содержащий методы работы с базой данных
 */
public abstract class DatabaseDAO {

    protected Database database = DatabaseManager.getDatabase("dbbr_db");
    ...
    public void stepAllureQueryText(String queryText) {
        AllureHelper.makeAttachTXT("Текст запроса в базу", queryText + "\n");
