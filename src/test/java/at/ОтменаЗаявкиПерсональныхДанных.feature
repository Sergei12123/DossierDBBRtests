#language: ru
  Функционал: отмена и доработка заявки

    @Ready
    Сценарий: отмена заявки на проверку персональных данных
      ...
      Тогда заполняет сведения об объекте проверки
          ...
          И нажимает кнопку "Отменить заявку" на экране "Добавление документов"
